          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              <div className="shrink-0 flex items-center">
                ...
                <Link href="/dashboard">
                  <img
                    src={logo}
                    alt="Logo"
                    className="block h-7 w-auto fill-current text-gray-800"
                  />
                </Link>
              </div>
              ...
              <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                <NavLink
                  href={route("userpapers.view")}
                  active={route().current("userpapers*")}
                  style={{ color: "#ffffff" }}
                >
                  Search
                </NavLink>
                {(userRole === "admin" || userRole === "assistant-admin") && (
                  <NavLink
                    href={
                      userRole === "assistant-admin"
                        ? "/papers-admin"
