...
<main className="bg-white">
    ...
    <section className="py-12">
        ...
        <div className="container mx-auto flex flex-col sm:flex-row items-center px-6 gap-8">
            ...
            <div className="sm:w-1/2">
                <img src={uploadedImage} alt="Landing Page Design" className="rounded-lg" />
            </div>
        </div>
    </section>
    ...
    <section className="bg-gray-50 py-12">
        <div className="container mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-8">
                {/* Left Side - Image */}
                <div className="sm:w-1/2">
                    <img src={uploadedImage1} alt="Group" className="rounded-lg" />
                </div>
                {/* Right Side - Text */}
                <div className="sm:w-1/2 text-left">
                    <h4 className="text-lg font-bold text-maroon-600">What We Offers:</h4>
    ...
    <div className="container mx-auto text-center">
        ...
        <div className="flex justify-center items-center gap-12"> {/* Increased gap */}
            {[
                ...
                <div key={index} className="flex flex-col items-center">
                    <div className="rounded-full bg-gray-200 w-32 h-32 flex items-center justify-center shadow-md overflow-hidden"> {/* Larger size */}
                        <img
                            src={creator.image}
                            alt={creator.name}
